...
// AUTO-GENERATED by test/helpers/synth_init.py from `test_synth_triangles_random`.
// Do not hand-edit. To regenerate:  make synth_kernel KERNEL=test_synth_triangles_random
//
