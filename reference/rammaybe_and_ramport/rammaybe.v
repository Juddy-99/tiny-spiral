...
module  rammaybe_meminit_p6k
	...
	defparam
		...
		addr_ctr.lpm_modulus = 65536,
		addr_ctr.lpm_port_updown = "PORT_UNUSED",
		addr_ctr.lpm_width = 16,
...
endmodule //rammaybe_meminit_p6k
//VALID FILE
...
module rammaybe (
	...
	rammaybe_meminit_p6k	rammaybe_meminit_p6k_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe.bsf TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe_inst.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe_bb.v TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe.inc TRUE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL rammaybe.cmp TRUE TRUE
